    ...
    return (
        <div>
            ...
            <div className='text-center my-14'>
                ...
                <h4 className=" my-9">
                   বিকাশে  <span className='bg-yellow-400'>01763572771</span> এই নম্বরে <span className='bg-yellow-400'>{finalTotalAmount*0.3} টাকা</span> সেন্ড মানি করে মেসেজে যে ট্রাঞ্জিকশন আইডি পাবেন সেটি <br /> <br /> অথবা বিকাশ নাম্বারের শেষের ৩ নম্বর প্রদান করুণ!
                </h4>
             <input className="w-96 border-2 py-2 px-9 rounded text-left text-xs border-black" onBlur={(e)=>transictionId=e.target.value} type="text" placeholder= 'মেসেজে পাওয়া ট্রাঞ্জিকশন আইডি প্রদান করুন অথবা বিকাশ নাম্বারের শেষের ৩ নম্বর প্রদান করুণ! ' />
